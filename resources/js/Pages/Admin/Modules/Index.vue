                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div class="flex space-x-2">
                    ...
                    <button
                      ...
                      :disabled="processing"
                      class="text-red-600 hover:text-red-900 disabled:opacity-50"
                      onclick="return confirm('Are you sure you want to uninstall this module? This action cannot be undone.')"
                    >
                      Uninstall
                    </button>
                  </div>
...
const uploadModule = () => {
  ...
  // Use router.post with proper file handling
  router.post(route('admin.modules.upload'), {
    ...
    onError: (errors) => {
      ...
      if (errors.upload) {
        alert('Upload failed: ' + errors.upload)
      } else if (errors.module_zip) {
        alert('File error: ' + errors.module_zip)
      } else {
